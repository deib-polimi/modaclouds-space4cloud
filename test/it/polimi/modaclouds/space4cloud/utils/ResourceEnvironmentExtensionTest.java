...
public class ResourceEnvironmentExtensionTest {
	...
	public void parseOfBizSample() {
		File extension = new File(
				"target/test/ofBiz_model/resource_model_extension_OfBiz.xml");
		...
		int[] first = { 1, 5, 2, 2, 10, 10, 5, 15, 15, 8, 8, 15, 10, 10, 20,
				10, 25, 7, 30, 30, 30, 18, 9, 40 };
		int[] second = { 3, 5, 10, 15, 20, 25, 15, 35, 20, 22, 25, 27, 30, 32,
				69, 74, 78, 42, 88, 93, 98, 103, 108, 57 };
