...
public class ProcessingResource {
	 ...
	 *
	 * @param type the type
	 * @param schedulingPolicy the scheduling policy
	 ...
	 *
	 * @param processingResourceElement the new processing resource element
	 */
	 ...
	 *
	 * @param processingRate the new processing rate
	 */
	 ...
	 *
	 * @param numberOfReplicas the new number of replicas
	 */
	 ...
	 * Sets the scheduling.
	 *
	 * @param schedulingPolicy the new scheduling
	 */
	 ...
	 * Sets the scheduling.
	 *
	 * @param scheduling the new scheduling
	 */
