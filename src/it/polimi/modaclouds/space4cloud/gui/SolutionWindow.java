...
public class SolutionWindow extends WindowAdapter implements PropertyChangeListener {
	...
	public SolutionWindow(SolutionMulti solutionMulti) {
	...
	public void setData(SolutionMulti solutionMulti) {
		...
		infoAll.append("<tr><td>Evaluation Time</td><td>" + Space4Cloud.durationToString(solutionMulti.getGenerationTime()) + " ms</td></tr>\n");
