...
public class SolutionWindowPanel extends JTabbedPane{
    ...
    public void setData(SolutionMulti solutionMulti) {      
        ...
        infoAll.append("<tr><td>Generation Time</td><td>" + Space4Cloud.durationToString(solutionMulti.getGenerationTime()) + "</td></tr>\n");
        ...
        for (int i = 0; i < solutionMulti.size(); ++i) {
            ...
            info.append("<tr><td>Generation Time</td><td>" + Space4Cloud.durationToString(solution.getGenerationTime()) + "</td></tr>\n");
