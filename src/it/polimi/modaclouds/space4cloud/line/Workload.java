...
public class Workload implements Cloneable, CopyTo, Equals, HashCode,
		MergeFrom, ToString {
	...
	public StringBuilder appendFields(ObjectLocator locator,
			StringBuilder buffer, ToStringStrategy strategy) {
		{
			...
			theStation = (((this.station != null) && (!this.station.isEmpty())) ? this
					.getStation() : null);
		...
		}
		{
			...
			strategy.appendField(locator, this, "throughput", buffer,
					theThroughput);
		}
		return buffer;
	}
	...
	public Object copyTo(ObjectLocator locator, Object target,
		...
		if (draftCopy instanceof Workload) {
			...
			if ((this.station != null) && (!this.station.isEmpty())) {
				...
				sourceStation = (((this.station != null) && (!this.station
						.isEmpty())) ? this.getStation() : null);
				@SuppressWarnings("unchecked")
				List<Station> copyStation = ((List<Station>) strategy.copy(
						LocatorUtils
								.property(locator, "station", sourceStation),
						sourceStation));
				copy.station = null;
				if (copyStation != null) {
			...
			if (this.throughput != null) {
				...
				Double copyThroughput = ((Double) strategy.copy(LocatorUtils
						.property(locator, "throughput", sourceThroughput),
						sourceThroughput));
	...
	public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator,
		...
		final Workload that = ((Workload) object);
		{
			...
			lhsStation = (((this.station != null) && (!this.station.isEmpty())) ? this
					.getStation() : null);
			List<Station> rhsStation;
			rhsStation = (((that.station != null) && (!that.station.isEmpty())) ? that
					.getStation() : null);
			if (!strategy.equals(
					LocatorUtils.property(thisLocator, "station", lhsStation),
					LocatorUtils.property(thatLocator, "station", rhsStation),
					lhsStation, rhsStation)) {
				return false;
			}
		}
		{
		...
		}
		{
			...
			if (!strategy.equals(LocatorUtils.property(thisLocator,
					"throughput", lhsThroughput), LocatorUtils.property(
					thatLocator, "throughput", rhsThroughput), lhsThroughput,
					rhsThroughput)) {
				return false;
			}
		}
	...
	public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
		int currentHashCode = 1;
		{
			...
			currentHashCode = strategy.hashCode(
					LocatorUtils.property(locator, "station", theStation),
					currentHashCode, theStation);
		}
		{
			String theName;
			theName = this.getName();
		...
		}
		{
			...
			currentHashCode = strategy
					.hashCode(LocatorUtils.property(locator, "throughput",
							theThroughput), currentHashCode, theThroughput);
		}
	...
	public void mergeFrom(ObjectLocator leftLocator,
		...
		if (right instanceof Workload) {
			...
			{
				List<Station> lhsStation;
				lhsStation = (((leftObject.station != null) && (!leftObject.station
						.isEmpty())) ? leftObject.getStation() : null);
				List<Station> rhsStation;
				rhsStation = (((rightObject.station != null) && (!rightObject.station
						.isEmpty())) ? rightObject.getStation() : null);
				List<Station> mergedStation = ((List<Station>) strategy.merge(
						LocatorUtils.property(leftLocator, "station",
								lhsStation), LocatorUtils.property(
								rightLocator, "station", rhsStation),
						lhsStation, rhsStation));
				target.station = null;
			...
			}
			{
				...
				Double mergedThroughput = ((Double) strategy.merge(LocatorUtils
						.property(leftLocator, "throughput", lhsThroughput),
						LocatorUtils.property(rightLocator, "throughput",
								rhsThroughput), lhsThroughput, rhsThroughput));
